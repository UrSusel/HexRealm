...
-- Insert Quests (22 standard + guild + 5 daily templates)
...
(1, 'Rat Problem', 'The village sewers are infested with rats. Bring me 5 rat tails.', 'blacksmith', '[{"id": 20, "quantity": 5}]', 30, 1, 1, 10, FALSE, TRUE, FALSE),
(2, 'Goblin Hunt', 'Goblins are raiding travelers. Collect 3 goblin ears as proof.', 'blacksmith', '[{"id": 21, "quantity": 3}]', 80, 2, 3, 10, FALSE, TRUE, FALSE),
(3, 'Desert Bandits', 'Clear the desert road of bandits. Bring 2 insignias.', 'armorer', '[{"id": 22, "quantity": 2}]', 150, 3, 8, 10, FALSE, TRUE, FALSE),
(4, 'Lava Cores Needed', 'I need lava cores for my research. Bring me 1.', 'clergy', '[{"id": 23, "quantity": 1}]', 300, 4, 12, NULL, FALSE, FALSE, FALSE),
(5, 'Demon Threat', 'A demon has been sighted. Bring its horn as proof of death.', 'clergy', '[{"id": 24, "quantity": 1}]', 500, 5, 15, NULL, FALSE, FALSE, FALSE),
(6, 'Leather Supplies', 'I need materials. Bring me 10 rat tails.', 'leathersmith', '[{"id": 20, "quantity": 10}]', 40, 1, 1, 8, FALSE, FALSE, FALSE),
(7, 'Scavenger Hunt', 'Collect various monster parts: 2 rat tails, 2 goblin ears.', 'leathersmith', '[{"id": 20, "quantity": 2}, {"id": 21, "quantity": 2}]', 100, 2, 5, 12, FALSE, FALSE, FALSE),
(8, 'Guild Contract: Goblin Extermination', 'The guild needs goblin ears for a bounty. Collect 10 ears.', 'blacksmith', '[{"id": 21, "quantity": 10}]', 800, 5, 10, NULL, TRUE, TRUE, FALSE),
(9, 'Guild Contract: Bandit Cleanup', 'Clear the roads of bandits. Bring 5 insignias.', 'armorer', '[{"id": 22, "quantity": 5}]', 1500, 8, 12, NULL, TRUE, TRUE, FALSE),
(10, 'Guild Contract: Lava Core Collection', 'The guild needs lava cores for enchanting. Bring 3.', 'clergy', '[{"id": 23, "quantity": 3}]', 2500, 10, 15, NULL, TRUE, TRUE, FALSE),
(11, 'Guild Contract: Demon Slayer', 'Hunt demons for the guild. Bring 2 demon horns.', 'clergy', '[{"id": 24, "quantity": 2}]', 5000, 15, 18, NULL, TRUE, TRUE, FALSE),
(12, 'Guild Contract: Supply Run', 'Gather materials for guild crafters: 15 rat tails, 8 goblin ears.', 'leathersmith', '[{"id": 20, "quantity": 15}, {"id": 21, "quantity": 8}]', 1200, 7, 10, NULL, TRUE, TRUE, FALSE),
(13, 'Guild Contract: Rat Invasion', 'The rats have returned stronger. Bring 20 rat tails.', 'blacksmith', '[{"id": 20, "quantity": 20}]', 500, 6, 5, NULL, TRUE, TRUE, FALSE),
(14, 'Guild Contract: Goblin Uprising', 'Goblins are multiplying. Collect 15 goblin ears.', 'blacksmith', '[{"id": 21, "quantity": 15}]', 900, 7, 6, NULL, TRUE, TRUE, FALSE),
(15, 'Guild Contract: Bandit Kings', 'The bandit kings must fall. Bring 8 insignias.', 'armorer', '[{"id": 22, "quantity": 8}]', 1800, 9, 10, NULL, TRUE, TRUE, FALSE),
(16, 'Guild Contract: Lava Harvesting', 'We need more lava cores for weapons. Bring 5.', 'clergy', '[{"id": 23, "quantity": 5}]', 3000, 8, 12, NULL, TRUE, TRUE, FALSE),
(17, 'Guild Contract: Demon Hunt', 'Demons are spreading chaos. Bring 4 demon horns.', 'clergy', '[{"id": 24, "quantity": 4}]', 4500, 10, 14, NULL, TRUE, TRUE, FALSE),
(18, 'Guild Contract: Mixed Materials', 'Gather 8 rat tails, 6 goblin ears, and 3 insignias.', 'leathersmith', '[{"id": 20, "quantity": 8}, {"id": 21, "quantity": 6}, {"id": 22, "quantity": 3}]', 2000, 8, 8, NULL, TRUE, TRUE, FALSE),
(19, 'Guild Contract: Monster Mastery', 'Prove your worth: 10 rat tails, 10 goblin ears, 5 insignias, 2 lava cores.', 'leathersmith', '[{"id": 20, "quantity": 10}, {"id": 21, "quantity": 10}, {"id": 22, "quantity": 5}, {"id": 23, "quantity": 2}]', 3500, 12, 12, NULL, TRUE, TRUE, FALSE),
(20, 'Guild Contract: Legendary Hunt', 'Hunt the most dangerous creatures: 5 lava cores and 3 demon horns.', 'clergy', '[{"id": 23, "quantity": 5}, {"id": 24, "quantity": 3}]', 6000, 14, 16, NULL, TRUE, TRUE, FALSE),
(21, 'Guild Contract: Final Trial', 'The ultimate challenge: 25 rat tails, 15 goblin ears, 10 insignias, 3 lava cores, 2 demon horns.', 'leathersmith', '[{"id": 20, "quantity": 25}, {"id": 21, "quantity": 15}, {"id": 22, "quantity": 10}, {"id": 23, "quantity": 3}, {"id": 24, "quantity": 2}]', 5000, 15, 18, NULL, TRUE, TRUE, FALSE),
(22, 'Guild Contract: Elite Extermination', 'Eliminate elite monsters: 12 goblin ears, 6 lava cores, and 4 demon horns.', 'clergy', '[{"id": 21, "quantity": 12}, {"id": 23, "quantity": 6}, {"id": 24, "quantity": 4}]', 7000, 16, 17, NULL, TRUE, TRUE, FALSE),
-- Daily Quest Templates (can be selected randomly for daily challenges)
...
ON DUPLICATE KEY UPDATE `title`=VALUES(`title`), `description`=VALUES(`description`), `required_items`=VALUES(`required_items`), `reward_gold`=VALUES(`reward_gold`), `reward_reputation`=VALUES(`reward_reputation`), `guild_required`=VALUES(`guild_required`), `repeatable`=VALUES(`repeatable`), `is_daily`=VALUES(`is_daily`), `max_level`=VALUES(`max_level`);
